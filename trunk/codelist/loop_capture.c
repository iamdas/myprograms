void call_back(u_char *argument,const struct pcap_pkthdr *pkt_header,const u_char *pkt_content)
{
	//call_back内容
}
int main()
{
	...
	/* <-查看数据链接类型 常见类型有：DLT_EN10MB、DLT_IEEE802、DLT_PPP等 */
		
	//--
	struct bpf_program bpf_filter;
	char bpf_filter_string[]="";	/* <-此处设置过滤规则 */
